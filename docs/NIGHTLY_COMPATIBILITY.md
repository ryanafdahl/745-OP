...
[Source audit](https://github.com/ryanafdahl/nrdr-jetstream/actions/runs/35476805824) passed: 75 portable tests twice, source syntax/import checks, native model inputs, and protected-tree checks. The NRDR-tree audit allows only the two reviewed hook files to differ from the clean base; the other protected trees remain exact matches.
